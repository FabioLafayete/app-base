...
class _$_LoginModel extends _LoginModel {
  const _$_LoginModel({required this.hasPassword}) : super._();
  ...
  @override
  String toString() {
    return 'LoginModel(hasPassword: $hasPassword)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, hasPassword);
...
abstract class _LoginModel extends LoginModel {
  const factory _LoginModel({required final bool hasPassword}) = _$_LoginModel;
